# Contributing to water-sample-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
water-sample-schema. These guidelines are not strict rules.
...
The water-sample-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the water-sample-schema technical leads
...
[issues]: https://github.com/sierra-moxon/water-sample-schema/issues/
[pulls]: https://github.com/sierra-moxon/water-sample-schema/pulls/
